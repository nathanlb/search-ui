...
export class Omnibox extends Component {
  ...
  static options: IOmniboxOptions = {
    ...
    /**
     *  The amount of focus time (in milliseconds) focusing a query suggestion required before requesting a preview of its top results.
     *
     * **Default:** `200`
     */
    querySearchResultPreviewsDelay: ComponentOptions.buildNumberOption({ defaultValue: 200 })
  };
